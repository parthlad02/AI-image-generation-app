...
const CreatePost = () => {
  ...
  return (
    ...
    <div>
      ...
      <form className='mt-16 maxw-w-3x1' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          <FormField
            LabelName='Your name'
            type='text'
            name='name'
            placeholder='Eg., Parth Lad'
            value={form.name}
        ...
        <div className='mt-10'>
            <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the image you want, you can share it with community</p>
          <button 
          type='submit'
